...
import { OUTREACH_PATH, OUTREACH_SIGNUP_PATH, OUTREACH_JOIN_PATH, OUTREACH_LOGIN_PATH, OUTREACH_VERIFY_PATH } from './lib/outreachRoutes'
import {
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<RouteLoadingScreen />}>
          <Routes>
            ...
            <Route path={OUTREACH_LOGIN_PATH} element={<OutreachLoginPage />} />
