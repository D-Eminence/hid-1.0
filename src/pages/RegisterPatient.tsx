          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ background: '#f9fafb', borderRadius: 10, padding: '16px 20px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[
                  { label: 'Full Name', value: success.full_name ?? 'N/A' },
                  { label: 'Date of Birth', value: success.dob ? formatDate(success.dob) : 'N/A' },
                  { label: 'Blood Group', value: success.blood_group ?? 'N/A' },
