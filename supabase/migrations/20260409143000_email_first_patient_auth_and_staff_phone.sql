...
drop function if exists public.hid_complete_staff_onboarding(text, text);
...
grant execute on function public.hid_complete_staff_onboarding(text, text, text) to authenticated;
